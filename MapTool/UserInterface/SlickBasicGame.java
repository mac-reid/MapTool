...
public class SlickBasicGame extends BasicGame{
    ...
    public static void main(String[] args)
			throws SlickException
    {
    	//JFRAME AND CANVASGAMECONTAINER
         /*CanvasGameContainer app =
			new CanvasGameContainer( new SlickBasicGame() );
 
         app.
         JFrame frame = new JFrame();
         JPanel panel = new JPanel();
         JPanel flickerTest = new JPanel();
         flickerTest.setMinimumSize(new Dimension(10,30));
         flickerTest.setBackground(Color.BLUE);
         panel.add(flickerTest);
         frame.add(panel);
         panel.add(app);
    	...
    	try{
    		appgc = new AppGameContainer(new SlickBasicGame());
